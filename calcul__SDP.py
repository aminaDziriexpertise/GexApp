...
def sdp():
       ...
       # if check:
        ...
        def surface_App_calcul_():

           #___________fonction de recuperation du Calque et de calcul la surface à afficher________
          def getCalqueAppliqueApplatSDP(calqueC , iscontour):
                print(calqueC)
                acad.ActiveDocument.SendCommand("(setq sel1 (SSGET\"_X\")" )
          ...
          def surface_plancher_ded():
              ...
              for element in layers_names:
                  ...
                  acad.ActiveDocument.SendCommand('.-hachures SOLID p s a s n a o i o h o \n')
                  acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_teinte_contour \n')
                  acad.ActiveDocument.SendCommand('.-hachures s "sel" \n' )
         ...
         #_________________________    Surfaces Vides    _____________________ 
          def surface_vides():
              ...
              sel_T = acad.ActiveDocument.SendCommand("(SSGET\"_X\"'((-4 . \"<OR\")(-4 . \"<AND\")(0 . \"*LWPOLYLINE\")(8 . \"GEX_EDS_sdp_2-tremie\")(-4 . \"AND>\")(-4 . \"<AND\")(0 . \"CIRCLE\")(8 . \"GEX_EDS_sdp_2-tremie\")(-4 . \"AND>\")(-4 . \"OR>\"))) ")
              print("_Surfaces  Planchers avant déductions est : ", get__layer_teinte_contour)
              acad.ActiveDocument.SendCommand('.-hachures p s a s n a o i o h o ' '\n')
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_2-tremie \n')
              acad.ActiveDocument.SendCommand('.-hachures s sel_T ' )
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_2-tremie_su  \n')
         ...
         #__________________________    Surfaces dont h < 1.80 m   _ _____________________ 
          def surface_h_180():
              get__layer_teinte_contour = acad.ActiveDocument.SendCommand('._-layer E 0 g * l GEX_EDS_sdp_2-tremie l GEX_EDS_sdp_2-tremie_su ' ) 
              sel_C = acad.ActiveDocument.SendCommand("(SSGET\"_X\"'((-4 . \"<OR\")(-4 . \"<AND\")(0 . \"*LWPOLYLINE\")(8 . \"GEX_EDS_sdp_3-h-180\")(-4 . \"AND>\")(-4 . \"<AND\")(0 . \"CIRCLE\")(8 . \"GEX_EDS_sdp_3-h-180\")(-4 . \"AND>\")(-4 . \"OR>\"))) ")
              print("_Surfaces  Planchers avant déductions est : ", get__layer_teinte_contour)
              acad.ActiveDocument.SendCommand('.-hachures p s a s n a o i o h o ' '\n')
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_3-h-180  \n')
              acad.ActiveDocument.SendCommand('.-hachures s sel_C ' )
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_3-h-180_su  \n')
         ...
         #__________________________    Surfaces Stationnement    ________________________
          def surface_Stationnement():
              get__layer_teinte_contour = acad.ActiveDocument.SendCommand('._-layer E 0 g * l GEX_EDS_sdp_2-tremie l GEX_EDS_sdp_2-tremie_su ' ) 
              sel_H = acad.ActiveDocument.SendCommand("(SSGET\"_X\"'((-4 . \"<OR\")(-4 . \"<AND\")(0 . \"*LWPOLYLINE\")(8 . \"GEX_EDS_sdp_5-PK\")(-4 . \"AND>\")(-4 . \"<AND\")(0 . \"CIRCLE\")(8 . \"GEX_EDS_sdp_5-PK\")(-4 . \"AND>\")(-4 . \"OR>\"))) ")
              print("_Surfaces  Planchers avant déductions est : ", get__layer_teinte_contour)
              acad.ActiveDocument.SendCommand('.-hachures p s a s n a o i o h o ' '\n')
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_5-PK  \n')
              acad.ActiveDocument.SendCommand('.-hachures s sel_H ' )
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_5-PK_su \n') 
              getCalqueAppliqueApplatSDP ("GEX_EDS_sdp_5-PK", 0)
         #_______________________________    Surfaces Combles    _________________________
          def surface_Combles():
              get__layer_teinte_contour = acad.ActiveDocument.SendCommand('._-layer E 0 g * l GEX_EDS_sdp_2-tremie l GEX_EDS_sdp_2-tremie_su ' ) 
              sel_L = acad.ActiveDocument.SendCommand("(SSGET\"_X\"'((-4 . \"<OR\")(-4 . \"<AND\")(0 . \"*LWPOLYLINE\")(8 . \"GEX_EDS_sdp_6-combles\")(-4 . \"AND>\")(-4 . \"<AND\")(0 . \"CIRCLE\")(8 . \"GEX_EDS_sdp_6-combles\")(-4 . \"AND>\")(-4 . \"OR>\"))) ")
              print("_Surfaces  Planchers avant déductions est : ", get__layer_teinte_contour)
              acad.ActiveDocument.SendCommand('.-hachures p s a s n a o i o h o ' '\n')
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_6-combles  \n')
              acad.ActiveDocument.SendCommand('.-hachures s sel_L ' )
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_6-combles_su \n') 
         ...
         #_________________________    Surfaces Locaux techniques    _____________________ 
          def surface_Locaux_techniques():
              get__layer_teinte_contour = acad.ActiveDocument.SendCommand('._-layer E 0 g * l GEX_EDS_sdp_2-tremie l GEX_EDS_sdp_2-tremie_su ' ) 
              sel_P = acad.ActiveDocument.SendCommand("(SSGET\"_X\"'((-4 . \"<OR\")(-4 . \"<AND\")(0 . \"*LWPOLYLINE\")(8 . \"GEX_EDS_sdp_7-LT\")(-4 . \"AND>\")(-4 . \"<AND\")(0 . \"CIRCLE\")(8 . \"GEX_EDS_sdp_7-LT\")(-4 . \"AND>\")(-4 . \"OR>\"))) ")
              print("_Surfaces  Planchers avant déductions est : ", get__layer_teinte_contour)
              acad.ActiveDocument.SendCommand('.-hachures p s a s n a o i o h o ' '\n')
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_7-LT \n')
              acad.ActiveDocument.SendCommand('.-hachures s sel_P ' )
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_7-LT_su \n')
              getCalqueAppliqueApplatSDP ("GEX_EDS_sdp_7-LT" , 0)
         #_____________________________    Surfaces Caves    ______________________________ 
          def surface_Caves():
              get__layer_teinte_contour = acad.ActiveDocument.SendCommand('._-layer E 0 g * l GEX_EDS_sdp_2-tremie l GEX_EDS_sdp_2-tremie_su ' ) 
              sel_S = acad.ActiveDocument.SendCommand("(SSGET\"_X\"'((-4 . \"<OR\")(-4 . \"<AND\")(0 . \"*LWPOLYLINE\")(8 . \"GEX_EDS_sdp_8-cave\")(-4 . \"AND>\")(-4 . \"<AND\")(0 . \"CIRCLE\")(8 . \"GEX_EDS_sdp_8-cave\")(-4 . \"AND>\")(-4 . \"OR>\"))) ")
              print("_Surfaces  Planchers avant déductions est : ", get__layer_teinte_contour)
              acad.ActiveDocument.SendCommand('.-hachures p s a s n a o i o h o  \n')
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_8-cave  \n')
              acad.ActiveDocument.SendCommand('.-hachures s sel_S ' )
              acad.ActiveDocument.SendCommand('._CLAYER GEX_EDS_sdp_8-cave_su  \n')
              getCalqueAppliqueApplatSDP ("GEX_EDS_sdp_8-cave" , 0)

         #_________________________Apres la calcul des différentes surfaces______________________
          def Total_surface():
